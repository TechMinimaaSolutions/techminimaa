    ...
    <section class="flex justify-center bg-gray-100 lg:py-11 py-7">
            <div class="rounded-2xl bg-white shadow-xl">  
                <form method="POST" action="" class="lg:p-11 p-7 mx-auto">
                    ...
                    <div class="mb-6">
                        <input type="email" name="email" class="w-full h-12 text-gray-900 placeholder:text-gray-400 text-lg font-normal leading-7 rounded-full border-gray-300 border shadow-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 px-4 " placeholder="Email" value="" required="" autocomplete="email">
                    ...
                    <div class="mb-1">
                        <input type="password" name="password" class="w-full h-12 text-gray-900 placeholder:text-gray-400 text-lg font-normal leading-7 rounded-full border-gray-300 border shadow-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 px-4 " placeholder="Password" required="" autocomplete="current-password">
