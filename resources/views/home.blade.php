...
@section('content')
<section x-data="{ mobileNavOpen: false }" class="relative pb-20 overflow-hidden">
    <img class="absolute top-0 right-0 w-52 md:w-auto" src="https://static.shuffle.dev/components/preview/2f808e47-944e-42cf-b821-2358251e0600/assets/public/saturn-assets/images/headers/star-background-header.png" alt="">
    <img class="absolute top-0 right-0 mt-10 mr-10" src="https://static.shuffle.dev/components/preview/2f808e47-944e-42cf-b821-2358251e0600/assets/public/saturn-assets/images/headers/light-orange-blue-1.png" alt="">
    <img class="absolute top-0 right-0 mt-64 sm:mt-80 lg:mt-64 w-2/5 animate-moveHand" src="https://static.shuffle.dev/components/preview/2f808e47-944e-42cf-b821-2358251e0600/assets/public/saturn-assets/images/headers/robot-hand-header.png" alt="">
