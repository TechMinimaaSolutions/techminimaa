<footer class="font-sans tracking-wide bg-gray-50 px-10 pt-12 pb-6">
    <div class="flex flex-wrap justify-between gap-10">
      <div class="max-w-md">
        <a href='javascript:void(0)'>
          <img src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1735299218Screenshot__55_-removebg-preview.png" alt="logo" class='w-36' />
        </a>
        <div class="mt-6">
          <p class="text-gray-600 leading-relaxed text-sm">Techminina IT Services delivers innovative and reliable IT solutions, empowering businesses to achieve digital transformation and operational excellence.</p>
        </div>
    ...
    <div class="flex flex-wrap max-md:flex-col gap-4">
      ...
      <p class='text-gray-600 text-sm md:ml-auto'>© TechMinimaa. All rights reserved.</p>
    </div>
  </footer>