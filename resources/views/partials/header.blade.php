<header class="py-1 px-4 sm:px-10 bg-blue-100 z-50 relative">
  <div class='max-w-7xl w-full mx-auto flex flex-wrap items-center gap-4'>
    <a href="javascript:void(0)"><img
        src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1735299218Screenshot__55_-removebg-preview.png" alt="logo"
        class='w-32' />
    </a>
    ...
    <div id="collapseMenu"
      ...
      <ul
        class='lg:!flex lg:ml-12 lg:space-x-6 max-lg:space-y-6 max-lg:fixed max-lg:bg-white  w-[100%] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
        <li class='max-lg:border-b max-lg:pb-4 px-3 lg:hidden'>
          <a href="javascript:void(0)"><img
              src="https://d1d5cy0fmpy9m8.cloudfront.net/images/1735299218Screenshot__55_-removebg-preview.png"
              alt="logo" class='w-32' />
          </a>
        </li>
